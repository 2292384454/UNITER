...
def random_word(tokens, vocab_range, mask, need_mask_idx):
    """
...
class MlmDataset(DetectFeatTxtTokDataset):
    ...
    def __getitem__(self, i):
        ...
        mapping = _get_mapping(converted_argmax, input_ids)
        # 对 mapping 去重
        ...
        return input_ids, img_feat, img_pos_feat, attn_masks, txt_labels, replace_map

    def create_mlm_io(self, input_ids, need_mask_idx):
        input_ids, txt_labels = random_word(input_ids,
                                            self.txt_db.v_range,
                                            self.txt_db.mask, need_mask_idx)
...
def mlm_collate(inputs):
    ...
    """
    (input_ids, img_feats, img_pos_feats, attn_masks, txt_labels, replace_map
